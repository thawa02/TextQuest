...
init python:
    ...
    bottle = Bottle()
    Drink = renpy.curry(bottle.drink)
    ...
    phone = Phone()
    TurnOffPhone = renpy.curry(phone.turn_off)
    TurnOnPhone = renpy.curry(phone.turn_on)
    ...
    hoodie = Hoodie()
    PutOffHoodie = renpy.curry(hoodie.put_off)
    PutOnHoodie = renpy.curry(hoodie.put_on)
